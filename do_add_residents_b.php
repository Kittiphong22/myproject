...
$sql = "SELECT * FROM residents_b WHERE เลขห้อง = '$เลขห้อง'";
...
if(mysqli_num_rows($result) > 0) {
    ...
    echo '</p>';
    echo '<a href="show_residents_b.php" style="text-decoration: none; color:#000000; background-color: #eee; padding: 5px 10px; border: 1px solid #000000;">กลับ</a>';
    echo '</div>';
    exit(0);
}

$sql = "INSERT INTO residents_b(เลขห้อง, ชื่อผู้อยู่, ที่อยู่, เบอร์โทร, ราคาห้อง)";
