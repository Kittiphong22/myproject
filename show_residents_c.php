...
echo "<center>";
$headerText = "ตึก C"; // ข้อความใน header
...
while ($row = mysqli_fetch_assoc($result)) {
    echo "<tr>
        ...
        <td>" . $row["ราคาห้อง"] . "</td>
        <td>
            <center><a href='edit_residents_c.php?เลขห้อง=" . $row["เลขห้อง"] . "' class='btn btn-primary'><i class='bi bi-pencil'></i> Edit</a>
            <a href='delete_residents_c.php?เลขห้อง=" . $row["เลขห้อง"] . "' class='btn btn-danger'><i class='bi bi-trash'></i> Delete</a>
            </center>
            </td>
    </tr>";
}
...
<body>   
    <center>
    <form method="post" action="add_residents_c.php">
        <!-- ปุ่ม submit -->
