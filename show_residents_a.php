...
if ($result) { // Check if the query was executed successfully
    ...
    $headerText = "ตึก A"; // ข้อความใน header
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>
            ...
            <td>
                ...
                <a href='delete_residents_a.php?เลขห้อง=" . $row["เลขห้อง"] . "' class='btn btn-danger'><i class='bi bi-trash'></i> Delete</a>
                </center>
                </td>
        </tr>";
    }
